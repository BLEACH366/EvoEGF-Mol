...
def compose_context(h_protein, h_ligand,
                    ...
                    batch_protein, batch_ligand, gen_flag_lig):
    ...
    return h_ctx, pos_ctx, batch_ctx, mask_ligand, mask_gen, protein_index_in_ctx, ligand_index_in_ctx
